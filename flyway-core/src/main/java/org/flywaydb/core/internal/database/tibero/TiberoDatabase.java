...
public class TiberoDatabase extends Database<TiberoConnection> {
    ...
    public final void ensureSupported() {
        ensureDatabaseIsRecentEnough("5");

        ensureDatabaseNotOlderThanOtherwiseRecommendUpgradeToFlywayEdition("6", org.flywaydb.core.internal.license.Edition.ENTERPRISE);

        recommendFlywayUpgradeIfNecessary("7");
    }
    ...
    boolean isDataDictViewAccessible(String name) throws SQLException {
        return isDataDictViewAccessible("SYSCAT", name);
    }
